    ...
    <div className="bg-slate-100">
      ...
      <div className="max-w-4xl mx-auto md:py-10 flex flex-col gap-10 pb-40">
        <div className="flex flex-col justify-between h-full pt-20 pb-24 px-10 gap-10 md:gap-10 md:p-20">
          <div className="flex flex-col gap-4 h-96 md:flex-row justify-between bg-white p-10 pb-20 md:p-20 rounded-xl">
            <h4 className="font-bold text-2xl md:w-1/2 py-2 md:py-0">
              Websites
            </h4>
