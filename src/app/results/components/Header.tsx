...
export const ResultsHeader = ({
  ...
  return (
    <div className={`relative h-[30rem] w-full bg-stone-800`}>
      <div
        className={
      ...
      ></div>
      <div className="z-20 relative w-full h-full p-10 md:p-20 transition flex flex-col justify-between max-w-5xl mx-auto">
        <Link
          href="/results"
          className="relative z-20 flex flex-row gap-2 text-white hover:underline mt-8 w-fit"
        >
          <svg
            width="20"
            viewBox="0 0 24 16"
        ...
        <div className="flex flex-col">
          <h2 className="text-5xl md:text-8xl text-white text-opacity-85">
            {heading}
          </h2>
